...
.then(() => browser.findElement(By.css('.upload-file')).sendKeys("C:\\Users\\sapti\\test_1\\file\\bulkUpload.xlsx"))
.then(() => browser.findElement(By.css('#excel-upload-submit')).click())